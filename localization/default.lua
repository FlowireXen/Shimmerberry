...
return {
	...
	misc = {
		labels = {
			...
			SEMBY_shimmer_immune = "Immune",--"Shimmer Immune",
			SEMBY_shiny = "Shiny",
		...
		challenge_names = {
			...
			c_SEMBY_qwest = "Qwest?",
			c_SEMBY_marked_negation = "Marked for Negation",
		...
		v_text = {
			...
			ch_c_SEMBY_perishable_fate = { "Age and {C:purple,E:2}Wither{}, old and bitter." },
			...
			ch_c_SEMBY_marked_negation = { "{C:SEMBY_resonance,E:1}Prepare for Deletion." },
			ch_c_SEMBY_last_one_left = { "The last one left to go is {C:red,E:1}Me{}." },
			...
			ch_c_SEMBY_doomed_cards = { "Gain {C:attention}2% {C:SEMBY_percent,E:2}Doom{} per card played" },
			ch_c_SEMBY_doomed_start = { "Start with {C:attention}100% {C:SEMBY_percent,E:2}Doom" },
			...
			ch_c_SEMBY_no_hands = { "Use {C:attention}all {C:blue}Hands{} each hand played" },
			...
			-- Lovely Patched:
			ch_m_ante_scaling = { "{C:legendary}X#1#{} base Blind size", },
