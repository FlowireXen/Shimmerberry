...
function SEMBY_TMTR_State(toggle)
	...
	SEMBY_TMTR_Spawn(toggle)
end

-- Toggle TMTRAINER Joker Spawn
function SEMBY_TMTR_Spawn(toggle)
	if toggle then G.GAME.SEMBY_TMTRAINER_SPAWN = (G.GAME.SEMBY_TMTRAINER_SPAWN or 0) + 1
	else G.GAME.SEMBY_TMTRAINER_SPAWN = (G.GAME.SEMBY_TMTRAINER_SPAWN or 0) - 1 end
	if G.GAME.SEMBY_TMTRAINER_SPAWN <= 0 then G.GAME.SEMBY_TMTRAINER_SPAWN = nil end
end
