...
Guest-Art by;<br>
<ins>lanedarushpy</ins> and <ins>GhostSalt</ins>.
...
<!-- Because We love to proof others Wrong! -->
<details>
...
| ---- |:------:|:-------:| ------ |
| Duplitage | Gives a copy of the<br>next obtained Joker<br>(Must have room) | Yes | "Scav. Prototype" |
...
| Eden Token | Use this Eden Token<br>to create a random<br>Joker of any rarity<br>(Must have room)<br>Self destructs when<br>Boss Blind is defeated | Eden Token,<br>Spectral |
...
## Enhancements
<details>
<summary>Click to show: Enhancements</summary>

| Name | Effect | Spawns? | Source |
| ---- |:------:|:-------:| ------ |
| Memory Card | [Suit] Memory:<br>+? chips<br>[Suit] Memories<br>gain +2 Chips,<br>has no rank | Yes | "The Backup" |
| Vintage Card | Retrigger if played<br>poker hand is not your<br>highest-level hand | Yes | "Microcosm" |
</details>

## Achievements
<details>
<summary>Click to show: Achievements</summary>

| Name | Unlock |
| ---- |:------:|
| Coming Out | Earn $0 from the<br>Golden Egg Blind |
...
Big thanks to the Guest-Artists:<br>
<ins><b>lanedarushpy</b></ins>: [Check out BalaCats](https://git.gay/hazelpy/BalaCats)<br>
<ins><b>GhostSalt</b></ins>: [Check out Phanta](https://balatromods.miraheze.org/wiki/Phanta)<br>
...
<b>110</b> Jokers, <b>20</b> Challenges,<br>
<b>7</b> Consumables, <b>5</b> Blinds and <b>4</b> Decks.<br>
